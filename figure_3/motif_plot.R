...
#Figure 3E, Extended Data Figures 3D, F, G, H, I
...
plots_list <- list(
          c("75","150","250", "500","75_150_250_500_1000"), #Figure 3E, Extended Data Figure 3D
          c("75_150","150_250","250_500","500_1000"), #Extended Data Figure 3F, H
          c("75_150_250","150_250_500","250_500_1000") #Extended Data Figure 3G, I
          )

#number of categories in each plot
new_names <- c("five","four","three")

#plot name prefix
file_var <- c("dosage_new_plots_no_1000","dosage_new_plots_two_sample","dosage_new_plots_three_sample")
...
#plot pval vs motif type, and then add text with label as specific motif name
  ...
  #save plots
  png(paste0("~/dosage_manuscript/figure_3/",file_var[t], "_pval_vs_motif_type_filtered_type_toplabel.png" ), width = 9, height = height_var1, units = "in", res = 200, bg = "transparent", type = "cairo-png")
  print(p1)
  dev.off()

  png(paste0("~/dosage_manuscript/figure_3/",file_var[t], "_pval_vs_motif_type_nolabel_filtered_type_toplabel.png" ), width = 4, height = height_var2, units = "in", res = 200, bg = "transparent", type = "cairo-png")
  print(p2)
  dev.off()
