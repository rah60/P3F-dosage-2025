...
#Figure 3E, Extended Data Figures 7E,F, parts of Supplemental Table 2
...
#plot pval vs motif type, and then add text with label as specific motif name
  ...
  png(paste0("~/dosage_manuscript/figure_3/",file_var[t], "_pval_vs_motif_type_nolabel_filtered_type_toplabel.png" ), width = width_var, height = height_var2, units = "in", res = 200, bg = "transparent", type = "cairo-png")
  print(p2)
  dev.off()

  #for Supplemental table 2
  write.table(results_df, paste0("~/dosage_manuscript/figure_3/motif_tables/",file_var[t],".tsv"), quote=F, row.names=F, sep="\t" )
